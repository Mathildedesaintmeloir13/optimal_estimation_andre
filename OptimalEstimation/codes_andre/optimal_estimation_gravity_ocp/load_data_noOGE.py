...
def stats(subject, trial, number_shooting_points):
    ...
    # --- Load --- #
    load_path = '/home/andre/BiorbdOptim/examples/optimal_estimation_gravity_ocp/Solutions/'
    ...
    angle_OE = params["gravity_angle"].squeeze()
    qddot = fd(states['q'], states['q_dot'], controls['tau'])

    rotating_gravity(biorbd_model, angle_OE.squeeze())
    ...
    angle_OGE = params_optimal_gravity["gravity_angle"].squeeze()
    ...
    save_path = 'Solutions/' + subject + '/' + os.path.splitext(c3d_name)[0] + '_stats'
    ...
    with open(save_variables_name, 'wb') as handle:
        pickle.dump({'subject': subject, 'trial': trial, 'adjusted_number_shooting_points': adjusted_number_shooting_points,
                     ...
                     'model_labels': model_labels, 'gravity': gravity, 'gravity_angle_OE': angle_OE, 'gravity_angle_OGE': angle_OGE,
