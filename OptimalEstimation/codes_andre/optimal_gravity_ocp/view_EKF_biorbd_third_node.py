...
def view(subject, trial, number_shooting_points):
    ...
    load_variables_name = load_path + subject + '/Kalman/' + os.path.splitext(c3d_name)[0] + "_third_node.pkl"
    ...
    q_kalman_biorbd = shift_by_2pi(biorbd_model, kalman_states['q'])
    # q_kalman_biorbd = kalman_states['q']
    qdot_kalman_biorbd = kalman_states['qd']
    qddot_kalman_biorbd = kalman_states['qdd']
...
if __name__ == "__main__":
    ...
    # Pieds manquants:
    # 821_contact_3 (surtout pied droit)
    # 821_822_3 (pied droit)
    # 821_seul_2 (pied droit vers la fin)
    # 821_seul_4 (pied gauche au début, un peu pied droit)
    # 821_seul_5 (pied droit vers le début)
    # DoCi 44_1 (pied droit, main gauche)
    # DoCi 44_3 (pied gauche)
    # 821_822_2
    # 821_contact_1 (pied gauche vers la fin)
    # 821_contact_2
    # 822_contact_1