...
if __name__ == "__main__":
    ...
    diff_Q_trans_EKF_OGE_44_all = []
    diff_Q_trans_EKF_OGE_821_all = []
    diff_Q_trans_EKF_OGE_822_all = []
    diff_Q_trans_EKF_OGE_833_all = []

    diff_Q_trans_EKF_OE_44_all = []
    diff_Q_trans_EKF_OE_821_all = []
    diff_Q_trans_EKF_OE_822_all = []
    diff_Q_trans_EKF_OE_833_all = []

    diff_Qdot_trans_EKF_OGE_44_all = []
    diff_Qdot_trans_EKF_OGE_821_all = []
    diff_Qdot_trans_EKF_OGE_822_all = []
    diff_Qdot_trans_EKF_OGE_833_all = []

    diff_Qdot_trans_EKF_OE_44_all = []
    diff_Qdot_trans_EKF_OE_821_all = []
    diff_Qdot_trans_EKF_OE_822_all = []
    diff_Qdot_trans_EKF_OE_833_all = []

    diff_Q_trans_EKF_OGE_44_segment = []
    diff_Q_trans_EKF_OGE_821_segment = []
    diff_Q_trans_EKF_OGE_822_segment = []
    diff_Q_trans_EKF_OGE_833_segment = []

    diff_Q_trans_EKF_OE_44_segment = []
    diff_Q_trans_EKF_OE_821_segment = []
    diff_Q_trans_EKF_OE_822_segment = []
    diff_Q_trans_EKF_OE_833_segment = []
    ...
    diff_Qdot_EKF_OGE_44_all = []
    diff_Qdot_EKF_OGE_821_all = []
    diff_Qdot_EKF_OGE_822_all = []
    diff_Qdot_EKF_OGE_833_all = []

    diff_Qdot_EKF_OE_44_all = []
    diff_Qdot_EKF_OE_821_all = []
    diff_Qdot_EKF_OE_822_all = []
    diff_Qdot_EKF_OE_833_all = []

    diff_Q_EKF_OGE_44_segment = []
    diff_Q_EKF_OGE_821_segment = []
    diff_Q_EKF_OGE_822_segment = []
    diff_Q_EKF_OGE_833_segment = []

    diff_Q_EKF_OE_44_segment = []
    diff_Q_EKF_OE_821_segment = []
    diff_Q_EKF_OE_822_segment = []
    diff_Q_EKF_OE_833_segment = []
    ...
    for subject, trial, _ in subjects_trials:
        ...
        if '44' in trial:
            diff_Q_trans_EKF_OGE_trial_all = diff_Q_trans_EKF_OGE_44_all
            diff_Q_trans_EKF_OE_trial_all = diff_Q_trans_EKF_OE_44_all
            diff_Qdot_trans_EKF_OGE_trial_all = diff_Qdot_trans_EKF_OGE_44_all
            diff_Qdot_trans_EKF_OE_trial_all = diff_Qdot_trans_EKF_OE_44_all
            diff_Q_trans_EKF_OGE_trial_segment = diff_Q_trans_EKF_OGE_44_segment
            diff_Q_trans_EKF_OE_trial_segment = diff_Q_trans_EKF_OE_44_segment
            diff_Q_EKF_OGE_trial_all = diff_Q_EKF_OGE_44_all
            diff_Q_EKF_OE_trial_all = diff_Q_EKF_OE_44_all
            diff_Qdot_EKF_OGE_trial_all = diff_Qdot_EKF_OGE_44_all
            diff_Qdot_EKF_OE_trial_all = diff_Qdot_EKF_OE_44_all
            diff_Q_EKF_OGE_trial_segment = diff_Q_EKF_OGE_44_segment
            diff_Q_EKF_OE_trial_segment = diff_Q_EKF_OE_44_segment
            ...
            diff_Q_trans_EKF_OGE_trial_all = diff_Q_trans_EKF_OGE_821_all
            diff_Q_trans_EKF_OE_trial_all = diff_Q_trans_EKF_OE_821_all
            diff_Qdot_trans_EKF_OGE_trial_all = diff_Qdot_trans_EKF_OGE_821_all
            diff_Qdot_trans_EKF_OE_trial_all = diff_Qdot_trans_EKF_OE_821_all
            diff_Q_trans_EKF_OGE_trial_segment = diff_Q_trans_EKF_OGE_821_segment
            diff_Q_trans_EKF_OE_trial_segment = diff_Q_trans_EKF_OE_821_segment
            diff_Q_EKF_OGE_trial_all = diff_Q_EKF_OGE_821_all
            diff_Q_EKF_OE_trial_all = diff_Q_EKF_OE_821_all
            diff_Qdot_EKF_OGE_trial_all = diff_Qdot_EKF_OGE_821_all
            diff_Qdot_EKF_OE_trial_all = diff_Qdot_EKF_OE_821_all
            diff_Q_EKF_OGE_trial_segment = diff_Q_EKF_OGE_821_segment
            diff_Q_EKF_OE_trial_segment = diff_Q_EKF_OE_821_segment
            ...
            diff_Q_trans_EKF_OGE_trial_all = diff_Q_trans_EKF_OGE_822_all
            diff_Q_trans_EKF_OE_trial_all = diff_Q_trans_EKF_OE_822_all
            diff_Qdot_trans_EKF_OGE_trial_all = diff_Qdot_trans_EKF_OGE_822_all
            diff_Qdot_trans_EKF_OE_trial_all = diff_Qdot_trans_EKF_OE_822_all
            diff_Q_trans_EKF_OGE_trial_segment = diff_Q_trans_EKF_OGE_822_segment
            diff_Q_trans_EKF_OE_trial_segment = diff_Q_trans_EKF_OE_822_segment
            diff_Q_EKF_OGE_trial_all = diff_Q_EKF_OGE_822_all
            diff_Q_EKF_OE_trial_all = diff_Q_EKF_OE_822_all
            diff_Qdot_EKF_OGE_trial_all = diff_Qdot_EKF_OGE_822_all
            diff_Qdot_EKF_OE_trial_all = diff_Qdot_EKF_OE_822_all
            diff_Q_EKF_OGE_trial_segment = diff_Q_EKF_OGE_822_segment
            diff_Q_EKF_OE_trial_segment = diff_Q_EKF_OE_822_segment
            ...
            diff_Q_trans_EKF_OGE_trial_all = diff_Q_trans_EKF_OGE_833_all
            diff_Q_trans_EKF_OE_trial_all = diff_Q_trans_EKF_OE_833_all
            diff_Qdot_trans_EKF_OGE_trial_all = diff_Qdot_trans_EKF_OGE_833_all
            diff_Qdot_trans_EKF_OE_trial_all = diff_Qdot_trans_EKF_OE_833_all
            diff_Q_trans_EKF_OGE_trial_segment = diff_Q_trans_EKF_OGE_833_segment
            diff_Q_trans_EKF_OE_trial_segment = diff_Q_trans_EKF_OE_833_segment
            diff_Q_EKF_OGE_trial_all = diff_Q_EKF_OGE_833_all
            diff_Q_EKF_OE_trial_all = diff_Q_EKF_OE_833_all
            diff_Qdot_EKF_OGE_trial_all = diff_Qdot_EKF_OGE_833_all
            diff_Qdot_EKF_OE_trial_all = diff_Qdot_EKF_OE_833_all
            diff_Q_EKF_OGE_trial_segment = diff_Q_EKF_OGE_833_segment
            diff_Q_EKF_OE_trial_segment = diff_Q_EKF_OE_833_segment
        ...
        diff_Q_trans_EKF_OGE_trial_all.append(data['diff_Q_trans_EKF_OGE'])
        diff_Q_trans_EKF_OE_trial_all.append(data['diff_Q_trans_EKF_OE'])
        diff_Qdot_trans_EKF_OGE_trial_all.append(data['diff_Qdot_trans_EKF_OGE'])
        diff_Qdot_trans_EKF_OE_trial_all.append(data['diff_Qdot_trans_EKF_OE'])
        diff_Q_trans_EKF_OGE_trial_segment.append(data['RMSE_difference_between_Q_trans_OGE_segment'])
        diff_Q_trans_EKF_OE_trial_segment.append(data['RMSE_difference_between_Q_trans_OE_segment'])

        diff_Q_EKF_OGE_trial_all.append(data['diff_Q_EKF_OGE'])
        diff_Q_EKF_OE_trial_all.append(data['diff_Q_EKF_OE'])
        diff_Qdot_EKF_OGE_trial_all.append(data['diff_Qdot_EKF_OGE'])
        diff_Qdot_EKF_OE_trial_all.append(data['diff_Qdot_EKF_OE'])
        diff_Q_EKF_OGE_trial_segment.append(data['RMSE_difference_between_Q_OGE_segment'])
        diff_Q_EKF_OE_trial_segment.append(data['RMSE_difference_between_Q_OE_segment'])
        ...
        missing_markers.append(data['mean_%_missing_markers'])

        qdot_EKF.append(data['qdot_EKF'])
        qdot_OGE.append(data['qdot_OGE'])
        qdot_OE.append(data['qdot_OE'])
    ...
    diff_Q_trans_all = np.array(diff_Q_trans_EKF_OGE_44_all + diff_Q_trans_EKF_OGE_821_all + diff_Q_trans_EKF_OGE_822_all + diff_Q_trans_EKF_OGE_833_all +
                        diff_Q_trans_EKF_OE_44_all + diff_Q_trans_EKF_OE_821_all + diff_Q_trans_EKF_OE_822_all + diff_Q_trans_EKF_OE_833_all)
    ...
    diff_Qdot_trans_all = np.array(diff_Qdot_trans_EKF_OGE_44_all + diff_Qdot_trans_EKF_OGE_821_all + diff_Qdot_trans_EKF_OGE_822_all + diff_Qdot_trans_EKF_OGE_833_all +
                             diff_Qdot_trans_EKF_OE_44_all + diff_Qdot_trans_EKF_OE_821_all + diff_Qdot_trans_EKF_OE_822_all + diff_Qdot_trans_EKF_OE_833_all)
    diff_Qdot_all = np.array(diff_Qdot_EKF_OGE_44_all + diff_Qdot_EKF_OGE_821_all + diff_Qdot_EKF_OGE_822_all + diff_Qdot_EKF_OGE_833_all +
                             diff_Qdot_EKF_OE_44_all + diff_Qdot_EKF_OE_821_all + diff_Qdot_EKF_OE_822_all + diff_Qdot_EKF_OE_833_all)
    diff_Q_segments = np.array(diff_Q_EKF_OGE_44_segment + diff_Q_EKF_OGE_821_segment + diff_Q_EKF_OGE_822_segment + diff_Q_EKF_OGE_833_segment +
                                    diff_Q_EKF_OE_44_segment + diff_Q_EKF_OE_821_segment + diff_Q_EKF_OE_822_segment + diff_Q_EKF_OE_833_segment, dtype=object)
    ...
    data_Q_all['diff_Q_trans_all'] = diff_Q_trans_all
    data_Q_all['diff_Qdot_trans_all'] = diff_Qdot_trans_all
    data_Q_all['diff_Qdot_all'] = diff_Qdot_all
    data_Q_all['diff_Q_segments'] = diff_Q_segments
    ...
    diff_markers_all = np.array(list(diff_markers_EKF_44_all.values()) + list(diff_markers_EKF_821_all.values()) + list(diff_markers_EKF_822_all.values()) + list(diff_markers_EKF_833_all.values()) +
                        list(diff_markers_OE_44_all.values()) + list(diff_markers_OE_821_all.values()) + list(diff_markers_OE_822_all.values()) + list(diff_markers_OE_833_all.values()) +
                        list(diff_markers_OGE_44_all.values()) + list(diff_markers_OGE_821_all.values()) + list(diff_markers_OGE_822_all.values()) + list(diff_markers_OGE_833_all.values()), dtype=object)
    ...
    recons_type_marker = np.array(['EKF'] * 3 * 4 + ['Marker tracking'] * 3 * 4 + ['Joint angle tracking'] * 3 * 4)
    ...
    clrs_bright = sns.color_palette("bright", 6)
    ...
    def grouped_barplot(df, cat, subcat, val, seg, ax_df):
        ...
        for i, gr in enumerate(subx):
            dfg = df[df[subcat] == gr]
            h_bar.append(ax_df.bar(x + offsets[i], dfg[val].apply(lambda x: np.mean(x)).values , width=width, label="{} {}".format(subcat, gr), yerr=dfg[val].apply(lambda x: np.std(x)).values, color=clrs_bright[3+i], zorder=0))
            for x_i in x:
        ...
        ax_df.set_xlabel(df['recons_type'].unique().squeeze(), fontsize=16)
        ax_df.set_xticks(x)
        ax_df.set_xticklabels(u)
        ax_df.tick_params(axis='both', labelsize=14)
    ...
    axs_marker_custom[0, 0].set_ylabel('Markers RMSD (mm)', fontsize=16)
    ...
    # Joint velocity Qdot difference
    fig_Qdot_all = pyplot.figure(figsize=(20, 10))
    axs_Qdot_all = fig_Qdot_all.gca()
    g_Qdot_all = sns.barplot(data=data_Q_all, x="movements", y="diff_Qdot_all", hue="recons_type", palette="bright", alpha=1, ax=axs_Qdot_all)
    g_Qdot_all.set_xlabel('Movements', fontsize=14)
    g_Qdot_all.set_ylabel('Joint velocity difference (°/s)', fontsize=14)
    g_Qdot_all.tick_params(labelsize=12)
    g_Qdot_all.legend(title="", fontsize=14)

    print(data_Q_all.groupby(['movements', 'recons_type']).mean())
    print(data_Q_all.groupby(['movements', 'recons_type']).std())
    print(data_Q_all.groupby('recons_type').mean())
    print(data_Q_all.groupby('recons_type').std())
    print('EKF marker error: ', np.mean(data_marker[0]['diff_markers_all'].sum()), ' ± ', np.std(data_marker[0]['diff_markers_all'].sum()))
    print('OGE marker error: ', np.mean(data_marker[2]['diff_markers_all'].sum()), ' ± ', np.std(data_marker[2]['diff_markers_all'].sum()))
    print('OE marker error: ', np.mean(data_marker[1]['diff_markers_all'].sum()), ' ± ', np.std(data_marker[1]['diff_markers_all'].sum()))
    print('Mean % of missing markers: ', np.mean(missing_markers), ' ± ', np.std(missing_markers))
    print('Max root velocity EKF: ', np.max([np.max(np.abs(qdot_trial[:3, :])) for qdot_trial in qdot_EKF]), np.max([np.max(np.abs(qdot_trial[3:6, :])) for qdot_trial in qdot_EKF])/np.pi*180)
    print('Max root velocity OGE: ', np.max([np.max(np.abs(qdot_trial[:3, :])) for qdot_trial in qdot_OGE]), np.max([np.max(np.abs(qdot_trial[3:6, :])) for qdot_trial in qdot_OGE])/np.pi*180)
    print('Max root velocity OE: ', np.max([np.max(np.abs(qdot_trial[:3, :])) for qdot_trial in qdot_OE]), np.max([np.max(np.abs(qdot_trial[3:6, :])) for qdot_trial in qdot_OE])/np.pi*180)
    ...
    fig_Q_all.savefig(save_name, bbox_inches='tight', dpi=300)

    fig_Qdot_all.tight_layout
    save_name = save_path + 'Joint_velocity_diff_barplot_all_noOGE' + '.png'
    fig_Qdot_all.savefig(save_name, bbox_inches='tight', dpi=300)

    fig_marker_custom.tight_layout
    save_name = save_path + 'Marker_error_barplot_custom_noOGE' + '.eps'
    fig_marker_custom.savefig(save_name, bbox_inches='tight', dpi=300)
