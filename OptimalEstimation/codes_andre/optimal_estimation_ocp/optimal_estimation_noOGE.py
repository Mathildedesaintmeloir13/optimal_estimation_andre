...
if __name__ == "__main__":
    ...
    GENERATE_KALMAN = True
    GENERATE_TRACKQ = True
    GENERATE_TRACK_MARKERS = True
    ...
    model_path = '../../Andre_data/Model/'
    c3d_path = '../../Andre_data/Essai/'
    kalman_path = '../../Andre_data/Q/'
    ...
    biorbd_model.setGravity(np.array([0, 0, -9.80639]))
    ...
    # optimal_gravity_filename = '../../Andre_data/Mixed_EKF/' + os.path.splitext(c3d_name)[0] + '_optimal_gravity_N' + str(adjusted_number_shooting_points) + '_mixed_EKF_noOGE' + ".bo"
    ...
    load_variables_name = '../../Andre_data/Kalman/' + os.path.splitext(c3d_name)[0] + ".pkl"
    ...
    sol_dic = {"states_sol": states, "control_sol": controls, "gravity": gravity}
    savemat(f"{save_name}.mat", sol_dic)
