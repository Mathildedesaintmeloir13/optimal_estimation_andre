...
import os
import sys
from OptimalEstimation_JointAccDriven import load_data_filename, reorder_markers
...
save_path = f'data/{subject}/EKF/'
save_variables_name = save_path + os.path.splitext(c3d_name)[0] + ".pkl"
